L.Control.StyledLayerControl = L.Control.Layers.extend({
		...
		_addItem : function (obj) {
			...
			//console.log(input.layerId._url);
			...
			//if (obj.group.id) {
				...
				//name2.setAttribute("class", "slide"); 
				
				//name2.innerHTML = '<a href="#" title="My tooltip text"><img src="Z:/Web/webpages/images/box/general/icons/dropdownbutton-blue.png" id="slider_button"></a>&nbsp;';
				//name2.innerHTML = '<input id="slide" type="range" min="0" max="1" step="0.01" value="1" onchange="object_' + [obj.layer._leaflet_id - 44] + '(this.value)"><img src="Z:/Web/webpages/images/box/general/icons/dropdownbutton-blue.png" id="slider_button"></input>&nbsp;';
				//name2.innerHTML = '<script> jQuery().ready(function() { jQuery( "#accordion_' + [obj.layer._leaflet_id] + '" ).accordion({ header: "h3"}); });</script><div id="accordion_' + [obj.layer._leaflet_id] + '"><h3>test</h3><div>Hello</div></div>';
				//name2.innerHTML = '<img src="Z:/Web/webpages/images/box/general/icons/dropdownbutton-blue.png" id="slider_button" data-id="object_' + [obj.layer._leaflet_id] + '">&nbsp;<div id="object_' + [obj.layer._leaflet_id] + '" class="hideDivs">Hello</div>';
				
				//name2.innerHTML = '<input id="slide_' + [obj.layer._leaflet_id] + '" type="range" min="0" max="1" step="0.01" value="1" onchange="updateOpacity' + [obj.layer._leaflet_id] + '(this.value)">';	
				//name2.innerHTML += '<script>function updateOpacity' + [obj.layer._leaflet_id] + '(value) { '[input.layerId] + '.setOpacity(value); }</script>';
			...
			if (!groupContainer) {
				...
				inputElement = '<input id="ac' + obj.group.id + rnum +'" name="accordion-1" class="menu" ' + s_expanded + s_type_exclusive + '/>';
				inputLabel   = '<label for="ac' + obj.group.id + rnum+'">' + obj.group.name + '</label>';
